...
public class ArquivoLivros extends Arquivo<Livro> {
  ...
  RandomAccessFile sw = new RandomAccessFile("stopWords/SW.txt", "r");
  ...
  public ArquivoLivros() throws Exception {
    ...
    lista = new ListaInvertida(4, "dados/dicionario.listainv.db", "dados/blocos.listainv.db");// instanciaçao da lista
                                                                                              // invertida
    String linhaArq;
  ...
  public boolean delete(int id) throws Exception {
    ...
    if (obj != null)// se o livro foi encontrado
      ...
      if (indiceIndiretoISBN.delete(ParIsbnId.hashIsbn(obj.getIsbn()))
          && relLivrosDaCategoria.delete(new ParIntInt(obj.getIdCategoria(), obj.getID()))) {// exclui do indicie
                                                                                             // indireto
  ...
  public boolean update(Livro novo) throws Exception {
    ...
    if (livroAntigo != null) {// Testa se existe um livro para ser alterado com o id
      ...
      if (livroAntigo.getIsbn().compareTo(isbn_novo) != 0) {
        ...
        indiceIndiretoISBN.create(new ParIsbnId(isbn_novo, novo.getID()));// cria um novo indicie indireto para o novo
                                                                          // livro
      }
